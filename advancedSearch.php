...
<head>
    ...
    <title>Advanced Search | DRodX Store</title>
...
<body class="home">
    ...
    <div class="container-fluid home">
        <div class="row">
            ...
            <div class="col-12  bgcolor mb-2">
                <div class="row">
                    <div class="offset-lg-2 col-12 ">
                        <div class="row">
                            <div class="col-1 col-lg-2 logo">
                                
                    
                                <!-- <div class="mt-1 mb-3 logo" style="height: 80px;"></div> -->
                            </div>
            ...
            <div class="offset-lg-2 col-12 col-lg-8 mb-3 bgcolor rounded">
                <div class="row">
            ...
            <div class="offset-lg-2 col-12 col-lg-8 bgcolor rounded mb-3">
                <div class="row">
