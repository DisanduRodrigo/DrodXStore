 ...
 * @copyright 202 - 2020 Marcus Bointon
 * @copyright 200 - 202 Jim Jagielski
...
class PHPMailer
{
    ...
    const CHARSET_ISO8859 = 'iso-8859-';
    ...
    /**
     * Email priority.
     * Options: null (default),  = High, 3 = Normal, 5 = low.
     ...
     * @var string
     */
    public $CharSet = self::CHARSET_ISO8859;
     ...
     * Set to 0 to not wrap. A useful value here is 78, for RFC2822 section 2.. compliance.
     *
     ...
     * (e.g. "smtp.example.com:25;smtp2.example.com").
     * You can also specify encryption type, for example:
     * (e.g. "tls://smtp.example.com:587;ssl://smtp2.example.com:465").
     ...
     * Default of 5 minutes (300sec) is from RFC282 section 4.5.3.2.
     *
     * @var int
     */
    public $Timeout = 300;
