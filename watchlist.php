...
<head>
    ...
    <title>Watchlist | DRodX Store</title>
                    ...
                    <div class="row">
                        <div class="col-12 border border-1 border-primary rounded mb-2">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <label class="form-label fs-1 ">Watchlist</label>
                                </div>
...
<!-- 
                                ...
                                ?>
                                    <!-- have products -->
                                    <div class=" offset-lg-2 col-12 col-lg-9">
                                        <div class="row">
                                            <?php
                                                    ...
                                                    <div class="row g-0">
                                                        ...
                                                        <div class="col-md-3 mt-5">
                                                            <div class="card-body d-lg-grid">
                                                                ...
                                                                <button class="btn btn-outline-success mb-2"  type="submit" id="payhere-payment" onclick="payNow(<?php echo $pid; ?>);">Buy Now</button>
