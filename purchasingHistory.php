...
<head>
    ...
    <title>Purchasing History | DRodX Store</title>
                            ...
                            ?>
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-1 bgcolor text-center text-lg-start">
                                            <label class="form-label text-white fs-6 py-5"><?php echo $invoice_data["invoice_id"]; ?></label>
                                        </div>
                                        <div class="col-12 col-lg-3 bgcolor">
                                            <div class="row">
                                        ...
                                        <div class="col-12 col-lg-1 text-center text-lg-end bgcolor">
                                            <label class="form-label fs-4 py-5"><?php echo $invoice_data["qty"]; ?></label>
                                        </div>
                                        <div class="col-12 col-lg-2 text-center text-lg-end bgcolor">
