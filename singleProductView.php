...
?>
        ...
        <head>
            ...
            <title><?php echo $product_data["title"]; ?> | DRodX Store</title>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12" style="padding: 10px;">
                                ...
                                border border-1 border-secondary mb-1">
                                    ...
                                    <div class="col-12 col-lg-6 order-3 bgcolor">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="row border-bottom border-dark">
                                                    <nav aria-label="breadcrumb">
                                                        <ol class="breadcrumb">
                                                            ...
                                                            <li class="breadcrumb-item active text-warning" aria-current="page">Single Product View</li>
                                                        </ol>
                                                    </nav>
                                                </div>
                                        ...
                                        <div class="row border-bottom border-dark">
                                            <div class="col-12 my-2">
                                                ...
                                                &nbsp;&nbsp; | &nbsp;&nbsp;
                                                <span class="fs-4 fw-bold text-black-50">Save Rs. <?php echo $difference; ?> .00 (5%)</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="my-2 offset-lg-2 col-12 col-lg-8 ">
                                                        <div class="row">
                    ...
                    <div class="col-12">
                        <!-- <div class="row">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="row border border-1 border-dark rounded overflow-scroll me-0" style="height: 200px;">
                                    ...
                                    ?>
                                        <div class="col-12 mt-1 mb-1 mx-1">
                                            <div class="row border border-1 border-dark rounded me-0">
                                                ...
                                                <div class="col-1 mt-1 mb-1 me-0">
