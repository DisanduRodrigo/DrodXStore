                ...
                <div class="card col-6 col-lg-2 mt-2 mb-2" style="width: 18rem;">
                    ...
                    <div class="card-body ms-0 m-0 text-center">
                        ...
                        ?>
                            ...
                            <span class="card-text  fw-bold"><?php echo $selected_data["qty"]; ?> Items Available</span><br /><br />
                            <a href='#' class="col-6 btn btn-success">Buy Now</a>
                            <button class="col-6 btn btn-dark mt-2">
                                <i class="col-6 bi bi-cart-plus-fill text-white fs-5"></i>
                            </button>
                        <?php
                        ...
                        ?>
                            ...
                            <a href='#' class="col-6 btn btn-success disabled">Buy Now</a>
