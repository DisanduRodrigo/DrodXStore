...
<head>
    ...
    <title>User Profile | DRodX Store</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 bg-body rounded mt-4 mb-4">
                            <div class="row g-2">
                                ...
                                <div class="col-md-3 border-end home">
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5 ">
                                        ...
                                        <label for="profileimage" class="btn btn-outline-dark mt-4" onclick="changeProfileImg();">Update Profile Image</label>

                                    </div>
                                </div>

                                <div class="col-lg-9 border-end  bgcolor">
                                    <div class="p-3 py-5">
