...
<head>
    ...
    <title>Add Product | DRodX Store</title>
...
<body>
    ...
    <div class="container-fluid bgcoloe home">
        <div class="row gy-3">
            <?php
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12 ">
                                            <textarea cols="30" rows="5" class="form-control bgcolor" id="desc"></textarea>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="offset-lg-3 col-12 col-lg-6">
                                            <div class="row">
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/empty.jpeg" class="img-fluid" style="width: 250px;" id="i0"/>
                                                </div>
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/empty.jpeg" class="img-fluid" style="width: 250px;" id="i1"/>
                                                </div>
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/empty.jpeg" class="img-fluid" style="width: 250px;" id="i2"/>
                                                </div>
                                            </div>
                                        </div>
