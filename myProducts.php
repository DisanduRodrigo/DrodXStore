...
?>
    ...
    <head>
        ...
        <title>My Products | DRodX Store</title>
        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-8">
                                    <div class=" offset-1 row text-center text-lg-start">
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-2 mx-2 mb-2 my-lg-4 mx-lg-0 d-grid">
                                    <button class="btn btn-btn btn-outline-dark fw-bold" onclick="window.location='addProduct.php'">Add Product</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="row">
                        <!-- filter -->
                        <!-- <div class="col-11 col-lg-2 mx-3 my-3 border bgcolor border-primary rounded">
                            <div class="row">
                        ...
                        <!-- product -->
                        <div class="col-12 col-lg-12  mb-3 home ">
                                        ...
                                        ?>
                                            ...
                                            <div class="card mb-3 mt-3 col-12 col-lg-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="offset-2 card-body  ">
                                                        <img class="col-8" src="<?php echo $product_img_data["img_path"]; ?>" class="img-fluid rounded-start img-thumbnail" />
                                                            <h5 class="card-title fw-bold"><?php echo $selected_data["title"]; ?></h5>
                                                            <span class="card-text fw-bold ">Rs. <?php echo $selected_data["price"]; ?> .00</span><br />
                                                            <span class="card-text fw-bold "><?php echo $selected_data["qty"]; ?> Items left</span>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="row g-1">
                                                                        <div class="col-12 d-grid">
                                                                            <button class=" btn btn-outline-warning fw-bold" onclick="sendid(<?php echo $selected_data['id']; ?>);">
                                                                                Update
                                                                            </button>
                                                                        </div>
                                                                    </div>
