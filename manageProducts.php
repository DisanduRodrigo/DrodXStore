...
<head>
    ...
    <title>Manage Products | Admins | DRodX Store</title>
    ...
    <div class="container-fluid home">
        <div class="row">
            ...
            <div class="col-12 header text-center">
                <label class="form-label text-dark fw-bold fs-1">Manage All Products</label>
            </div>
            ...
            ?>
                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        <div class="col-2 col-lg-1 bg-success py-2 text-end">
