    ...
    <div class="container-fluid home">
        <div class="row">
            ...
            if (isset($_SESSION["u"])) {
                ...
                $shipping = 0;
            ?>
                <div class="col-12 pt-2" style="background-color: #8e95a6;">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="home.php"><h3>Home</h3></a></li>
                            <li class="breadcrumb-item active" aria-current="page"><h2>Cart</h2></li>
                        </ol>
                    </nav>
                </div>

                <div class="col-12 border border-1 border-primary home rounded mb-3">
                    <div class="row">

                        <div class="col-12">
                            <label class="form-label fs-1 fw-bold">Cart <i class="bi bi-cart4 fs-1 text-warning"></i></label>
                        </div>
